...
const API_BASE_URL = `${apiBaseUrl}/api/settings/registered-workers`;
              ...
              <div className="p-6 mt-2">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    {error && (
                      <p className="text-red-500 text-center text-sm mt-2 pt-3">
                        {error}
                      </p>
                    )}
                    {success && (
                      <p className="text-green-500 text-center text-sm mt-2 pt-3">
                        {success}
                      </p>
                    )}
                  </div>
